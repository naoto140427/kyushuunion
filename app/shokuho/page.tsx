...
export default function ShokuhoPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-700 font-sans selection:bg-emerald-100 p-6 pb-32">
      <header className="mb-8 pt-4 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight text-slate-800">
            職場訪問用<span className="text-emerald-400">.</span>
          </h1>
        </div>
      </header>
